...
class attentionMatrix(nn.Module):
    def __init__(self, 
        ...
        if dimension == 3:
            conv_nd = nn.Conv3d
            max_pool_layer = nn.MaxPool3d(kernel_size=(1, 8, 8))
        elif dimension == 2:
            conv_nd = nn.Conv2d
            max_pool_layer = nn.MaxPool2d(kernel_size=(8, 8))
        else:
            conv_nd = nn.Conv1d
            max_pool_layer = nn.MaxPool1d(kernel_size=(8))
...
class NLKD_IN_8x8_Loss(nn.Module):
    def __init__(self, 
                 in_channels, 
                 inter_channels=None, 
                 dimension=2, 
                 ...
                 tau=1.0, 
                 loss_weight=1.0):
        super(NLKD_IN_8x8_Loss, self).__init__()
        self.in_channels = in_channels
...
if __name__ == '__main__':
    ...
    nlkd_loss = NLKD_IN_8x8_Loss(in_channels=256, dimension=2)
