...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_nlkd_fpn0=dict(type='NLKD_IN_Loss', in_channels=256, dimension=2, loss_weight=20),
            loss_nlkd_fpn1=dict(type='NLKD_IN_Loss', in_channels=256, dimension=2, loss_weight=20),
            loss_nlkd_fpn2=dict(type='NLKD_IN_Loss', in_channels=256, dimension=2, loss_weight=20),
            loss_nlkd_fpn3=dict(type='NLKD_IN_Loss', in_channels=256, dimension=2, loss_weight=20),
        ),  
