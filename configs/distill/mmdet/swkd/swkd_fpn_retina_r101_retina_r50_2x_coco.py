...
model = dict(
    ...
    distiller=dict(
        ...
        distill_losses=dict(
            loss_swkd_fpn0=dict(
                type='ShiftWindowLoss', patch_sizes=[3, 5, 7], k=[500, 500, 500], channels_list=[256, 256, 256], strides=[1, 1, 1]),
            loss_swkd_fpn1=dict(
                type='ShiftWindowLoss', patch_sizes=[3, 5, 7], k=[250, 250, 250], channels_list=[256, 256, 256], strides=[1, 1, 1]),
            loss_swkd_fpn2=dict(
                type='ShiftWindowLoss', patch_sizes=[2, 4], k=[40, 40], channels_list=[256, 256], strides=[1, 1]),
            loss_swkd_fpn3=dict(
                type='ShiftWindowLoss', patch_sizes=[2], k=[10], channels_list=[256], strides=[1]),
        ),
